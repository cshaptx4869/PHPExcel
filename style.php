...
->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);*/
	$objSheet->getDefaultStyle()->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER)->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);//设置excel文件默认水平 垂直方向居中
...
/**
**根据下标获得单元格所在列位置,range-根据范围创建数组，包含指定的元素
**/
